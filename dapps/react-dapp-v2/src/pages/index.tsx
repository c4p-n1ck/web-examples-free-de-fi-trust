...
const Home: NextPage = () => {
  ...
  const onSendCastNotify = async () => {
    ...
    console.log(
      "[PUSH DEMO] POST'ing to https://staging.cast.walletconnect.com/notify with body: ",
      notifyBody
    );

    const response = await fetch(
      `https://staging.cast.walletconnect.com/${DEFAULT_PROJECT_ID}/notify`,
      {
        method: "POST",
        headers: {
    ...
    console.log(
      "[PUSH DEMO] https://staging.cast.walletconnect.com/notify result:",
      data
    );
  };
